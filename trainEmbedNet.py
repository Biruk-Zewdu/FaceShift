...
parser.add_argument('--max_epoch',      type=int,   default=14,    help='Maximum number of epochs');
parser.add_argument('--trainfunc',      type=str,   default="arcface",  help='Loss function to use');
...
parser.add_argument('--scale',          type=float, default=16,     help='Loss scale, only for some loss functions');
parser.add_argument('--alpha',          type=float, default=1.0,    help='Weight for standard CE in symmetric cross entropy loss');
parser.add_argument('--beta',           type=float, default=1.0,    help='Weight for reverse CE in symmetric cross entropy loss');
...
parser.add_argument('--train_path',     type=str,   default="/home/gkim/Desktop/biruk/FaceShift/FaceShiftV2/ee488_24_face/data/ee488_24_data/train1",   help='Absolute path to the train set');
parser.add_argument('--train_ext',      type=str,   default="jpg",  help='Training files extension');
parser.add_argument('--test_path',      type=str,   default="/home/gkim/Desktop/biruk/FaceShift/FaceShiftV2/ee488_24_face/data/ee488_24_data/val",     help='Absolute path to the test set');
parser.add_argument('--test_list',      type=str,   default="/home/gkim/Desktop/biruk/FaceShift/FaceShiftV2/ee488_24_face/data/ee488_24_data/val_pairs.csv",   help='Evaluation list');
