...
class LossFunction(nn.Module):
    ...
    def forward(self, x, label=None):
        ...
        # # Just before the loss function call
        # print("cos_sim_matrix shape:", cos_sim_matrix.shape, "dtype:", cos_sim_matrix.dtype)
        # print("label shape:", label.shape, "dtype:", label.dtype)

        # # Check for NaN or Inf
        # print("NaN in cos_sim_matrix:", torch.isnan(cos_sim_matrix).any())
        # print("Inf in cos_sim_matrix:", torch.isinf(cos_sim_matrix).any())
